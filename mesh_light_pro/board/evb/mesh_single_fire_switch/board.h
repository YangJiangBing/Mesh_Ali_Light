...
#define SWITCH_POLARITY_ACTIVE_LOW      0
#define LEFT_SWITCH_PIN                 P2_4
#define LEFT_SWITCH_PIN_DB_MS           10
#define LEFT_SWITCH_IRQn                GPIO20_IRQn
#define Left_Switch_Handler             GPIO20_Handler

#define LEFT_LIGHT_PIN                  P4_3
