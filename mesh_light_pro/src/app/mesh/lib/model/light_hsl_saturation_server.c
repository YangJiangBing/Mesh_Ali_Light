                                             ...
                                             generic_transition_time_t trans_time)
{
    ...
    {
        light_hsl_saturation_publish(pmodel_info, saturation_after_set);
    }
                                                    ...
                                                    uint32_t delay_type)
{
    ...
    light_hsl_saturation_process(pmodel_info, psaturation_info->target_saturation,
                                 psaturation_info->trans_time);
