                                      ...
                                      generic_transition_time_t trans_time)
{
    ...
    {
        light_hsl_hue_publish(pmodel_info, hue_after_set);
    }
...
static int32_t light_hsl_hue_delay_execution(mesh_model_info_t *pmodel_info, uint32_t delay_type)
{
    ...
    light_hsl_hue_process(pmodel_info, phue_info->target_hue, phue_info->trans_time);
...
#endif
                {
                    present_hue = light_hsl_hue_process(pmodel_info, phue_info->target_hue, trans_time);
                }
