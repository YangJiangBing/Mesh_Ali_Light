                                          ...
                                          void *pargs)
{
	...
	DBG_DIRECT("===litght lightness app.c generic_on_off_server_data");
                                           ...
                                           void *pargs)
{
    ...
    DBG_DIRECT("===litght lightness app.c light_lightness_server_data");
    int32_t ret = MODEL_SUCCESS;
    switch (type)
    {
    ...
    case LIGHT_LIGHTNESS_SERVER_SET:
		DBG_DIRECT("===LIGHT_LIGHTNESS_SERVER_SET");
        {
            light_lightness_server_set_t *pdata = pargs;
#if USE_SIG_TRANSITION // 0
    ...
    case LIGHT_LIGHTNESS_SERVER_SET_LINEAR:
    	DBG_DIRECT("===LIGHT_LIGHTNESS_SERVER_SET_LINEAR");
        {
            light_lightness_server_set_t *pdata = pargs;
