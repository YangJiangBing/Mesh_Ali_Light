                                          ...
                                          void *pargs)
{
    ...
    case GENERIC_ON_OFF_SERVER_SET:
        {
						DBG_DIRECT("===light_ctl_hsl_server_app light_cw_turn_on_off");
...
static int32_t light_lightness_server_data(const mesh_model_info_p pmodel_info, uint32_t type,
                                           void *pargs)
{
	  DBG_DIRECT("===light_ctl_hsl_server_app light_lightness_server_data");
    switch (type)
    {
    ...
    case LIGHT_LIGHTNESS_SERVER_SET:
        {
						//DBG_DIRECT("===light_ctl_hsl_server_app LIGHT_LIGHTNESS_SERVER_SET");
    ...
    case LIGHT_LIGHTNESS_SERVER_SET_LINEAR:
        {
					  //DBG_DIRECT("===light_ctl_hsl_server_app LIGHT_LIGHTNESS_SERVER_SET_LINEAR");
...
static int32_t light_ctl_server_data(const mesh_model_info_p pmodel_info, uint32_t type,
                                     void *pargs)
{
	  DBG_DIRECT("===light_ctl_hsl_server_app light_ctl_server_data");
    switch (type)
    {
...
static int32_t light_hsl_server_data(const mesh_model_info_p pmodel_info, uint32_t type,
                                     void *pargs)
{
	  DBG_DIRECT("===light_ctl_hsl_server_app light_hsl_server_data");
    switch (type)
    {
