    ...
    case SENSOR_CLIENT_STATUS_CADENCE:
        {
            ...
            data_uart_debug("src = %d, property id = %d, divisor = %d, trigger type = %d, ", pdata->src,
                            pdata->property_id,
    ...
    case SENSOR_CLIENT_STATUS_SETTING:
        {
            ...
            data_uart_debug("src = %d, property id = %d, setting property id = %d", pdata->src,
                            pdata->property_id,
    ...
    case SENSOR_CLIENT_STATUS:
        {
            ...
            data_uart_debug("marshalled sensor data = src = %d, ", pdata->src);
    ...
    case SCHEDULER_CLIENT_STATUS_ACTION:
        {
            ...
            data_uart_debug("src = %d, index = %d, year = %d, month = %d, day = %d, hour = %d, minute = %d, second = %d, \
