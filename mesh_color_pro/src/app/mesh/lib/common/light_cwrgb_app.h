...
typedef struct
{
	...
	float lightness_present;	//亮度百分比
	float lightness_present_cool;	//亮度百分比
	
	uint16_t cool_lightness;
	uint16_t warm_lightness;
	
	uint16_t color_value; 		 //转换后的color value
	uint16_t cool_color_value;	 
	uint16_t warm_color_value;
